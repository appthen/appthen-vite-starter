          ...
          >
            ...
            >
              ...
              <View
                ...
                className="projectManagement__main_body__vw__vw1 M-gb-click"
              >
                <Image
                  src={static_image}
                  remote={false}
                  fit={false}
                  className="projectManagement__main_body__vw__vw1__Image"
                />
              ...
              <View
                ...
                className="projectManagement__main_body__vw__vw3 M-gb-click"
              >
                <AtIcon color="#fe935f" size={16} svg={ICONS["svg_2sv61t"]} />
              ...
              <View className="projectManagement__main_body__vw__vw6">
                <View className="projectManagement__main_body__vw__vw6__vw">
                  <View className="projectManagement__main_body__vw__vw6__vw__vw M-flex-item">
                    <View
                      className="projectManagement__main_body__vw__vw6__vw__vw__vw M-gb-click"
                      onClick={(e) => {}}
                    >
                      <Image
                        src={static_r1_image}
                        remote={false}
                        fit={false}
                        className="projectManagement__main_body__vw__vw6__vw__vw__vw__Image"
                      />
                    </View>
                    <View
                      className="projectManagement__main_body__vw__vw6__vw__vw__vw1 M-gb-click"
                      onClick={(e) => {}}
                    >
              ...
              {!!$eval(() => this.state.userInfo?.username) && (
                <View
                  ref={this._refsManager.linkRef("view-2f0112e1")}
                  className="projectManagement__main_body__vw__vw8"
                >
                  ...
                  <View
                    className="projectManagement__main_body__vw__vw8__vw1 M-gb-click"
                    onClick={function () {
              ...
              {!!false && (
                <View
                  ...
                  className="projectManagement__main_body__vw__vw10 M-gb-click"
                >
                  <AtIcon color="#fe935f" size={16} svg={ICONS["svg_ujubhc"]} />
              ...
              {!!false && (
                <View
                  ...
                  className="projectManagement__main_body__vw__vw11 M-gb-click"
                >
                  <AtIcon color="#fe935f" size={16} svg={ICONS["svg_oq8tai"]} />
            ...
            <View className="projectManagement__main_body__vw1 M-flex-item">
              <View
                ...
                className="projectManagement__item_list M-flex-item"
              >
