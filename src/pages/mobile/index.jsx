...
import "./index.scss";
const { px, RefsManager, $eval, $evalArray, $createChildContext } = utils;
  ...
  render() {
    ...
    return (
      <Page
        ...
        absolute={false}
        statusBarMode="light"
        backgroundImage="https://file.mengti.cc/FmV6MakP1HZ8GVeC_2YybgHYSE72"
        className="mobile__move"
      >
        <Modal
          style={{
            height: "100%",
          ...
          animate="slide-left"
          renderView={(props) => (
            <View className="mobile__vw M-flex-item">
              <View
                ref={this._refsManager.linkRef("view-83d9c761")}
                className="mobile__vw__vw"
              >
              ...
              <ScrollView>
                <View
                  ref={this._refsManager.linkRef("view-c5ef6035")}
                  className="mobile__vw_1"
                >
                  <View
                    inlineStyle={[
                      {
                    ...
                    ref={this._refsManager.linkRef("view-33b4c3b4")}
                    onClick={function () {
                      return this.switchTab.apply(
                        this,
                    ...
                    className="mobile__vw_1__vw M-gb-click"
                  >
                    <Image
                      src={static_image}
                      remote={false}
                      fit={false}
                      className="mobile__vw_1__vw__Image"
                    />
                  ...
                  <View
                    ...
                    className="mobile__vw_1__vw2 M-gb-click"
                  >
                    <AtIcon
                      color="#fe935f"
                      size={16}
                      svg={ICONS["svg_6c1pce"]}
                    />
                  ...
                  <View className="mobile__vw_1__vw5">
                    <View className="mobile__vw_1__vw5__vw">
                      <View className="mobile__vw_1__vw5__vw__vw M-flex-item">
                        <View
                          className="mobile__vw_1__vw5__vw__vw__vw M-gb-click"
                          onClick={(e) => {}}
                        >
                          <Image
                            src={static_r1_image}
                            remote={false}
                            fit={false}
                            className="mobile__vw_1__vw5__vw__vw__vw__Image"
                          />
                        </View>
                        <View
                          className="mobile__vw_1__vw5__vw__vw__vw1 M-gb-click"
                          onClick={(e) => {}}
                        >
                    ...
                    <View className="mobile__vw_1__vw6__vw">
                      <View className="mobile__vw_1__vw6__vw__vw M-flex-item">
                        ...
                        <a
                          ...
                          target="_blank"
                        >
                          <View className="projectManagement__main_body__vw__vw7__vw__vw__vw2 M-gb-click">
                            <View style={{}}>
                              <Image
                                src={static_r3_image}
                                remote={false}
                  ...
                  {!!$eval(() => _this.state.userInfo?.username) && (
                    <View
                      ref={this._refsManager.linkRef("view-d0186596")}
                      className="mobile__vw_1__vw7"
                    >
                      ...
                      <View
                        className="mobile__vw_1__vw7__vw1 M-gb-click"
                        onClick={function () {
                          return this.logOut.apply(
                            this,
                            Array.prototype.slice.call(arguments).concat([])
                          );
                        }.bind(_this)}
                  ...
                  {!!false && (
                    <View
                      ...
                      className="mobile__vw_1__vw9 M-gb-click"
                    >
                      <AtIcon
                        color="#fe935f"
                        size={16}
                        svg={ICONS["svg_nf6pmy"]}
                      />
                  ...
                  {!!false && (
                    <View
                      ...
                      className="mobile__vw_1__vw10 M-gb-click"
                    >
                      <AtIcon
                        color="#fe935f"
                        size={16}
                        svg={ICONS["svg_0sm7g9"]}
                      />
          ...
          visible={false}
          maskClosable={true}
          ref={this._refsManager.linkRef("modal")}
        />
        <View className="mobile__move__vw1">
          <View
            ref={this._refsManager.linkRef("view-3c6ffa92")}
            className="mobile__main_body"
          >
            <View className="mobile__main_body__vw M-flex-item">
              ...
              >
                <View style={{}}>
                  <AtIcon color="#666" size={25} svg={ICONS["svg_rzfy8j"]} />
                </View>
                ...
                <View
                  ref={this._refsManager.linkRef("view-6ef0fbeb")}
                  className="mobile__main_body__vw__vw__vw2"
                >
                  <AtIcon color="#c8c8c8" size={28} svg={ICONS["svg_fxjm46"]} />
              ...
              <View
                ref={this._refsManager.linkRef("view-26b80ba7")}
                className="mobile__item_list M-flex-item"
              >
                {!!$eval(() => this.state.currentTab === "qrcode") && (
                  <QrcodeApp
                    title=""
                    ref={this._refsManager.linkRef("qrcodeapp-1238bca5")}
                    isMobile={true}
                  />
                )}
                {!!$eval(() => this.state.currentTab === "store") && (
                  <ApplicationList
                    title=""
                    ref={this._refsManager.linkRef("applicationlist-b3f982db")}
                    onChangeApp={(app) => {
