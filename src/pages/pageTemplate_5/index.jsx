...
class PageTemplate_5$Page extends React.Component {
  ...
  utils = Object.assign({
    getRoute: utils.createRoute('pageTemplate_5')
  }, utils);
  constants = constants;
  ...
  render() {
    ...
    return <Page statusBarMode='light'>
        ...
        style: {
          ...
          <FDPageHeader fullWidth={true} ref={this._refsManager.linkRef('fdpageheader-e35bfed2')} className='pageTemplate_5__page_header'>
            <FDRow width='' className='pageTemplate_5__row_container'>
              <FDCell align='left' verAlign='top' ref={this._refsManager.linkRef('fdcell-63f8f66e')} className='pageTemplate_5__container'>
                <FDP>
                  <MyHeader title='' />
                </FDP>
              </FDCell>
          ...
          <FDSection gap={12} ref={this._refsManager.linkRef('fdsection-96d15fb1')} className='pageTemplate_5__region'>
            <FDBlock span={6} className='pageTemplate_5__region__FDBlock'>
              <FDRow width='' gap={10} className='pageTemplate_5__row_container_1'>
                <FDCell align='left' verAlign='top' width='' className='pageTemplate_5__row_container_1__FDCell' />
              </FDRow>
            </FDBlock>
            <FDBlock span={6} className='pageTemplate_5__block'>
              <FDCell />
            </FDBlock>
          </FDSection>
          <FDPageNav width={260}>
        ...
        <Modal style={{}} animate='pop' renderView={props => <View className='pageTemplate_5__vw' />} visible={false} maskClosable={true} />
      </Page>;
  }

}

export default PageTemplate_5$Page;